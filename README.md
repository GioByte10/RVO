...
In order to test this, I will be using CLion's disassembler to analyze the assembly code generated by the compiler. I will be using the following code as an example:
## Code
```C++
#include <vector>
#include <iostream>
